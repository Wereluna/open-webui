...
async def search_notes(
    ...
    try:
        ...
        for note in result.items:
            ...
            content_snippet = ''
            md_content = ensure_md_string(((note.data or {}).get('content') or {}).get('md') or '')
            if md_content:
...
async def view_note(
    ...
    try:
        ...
        content = ensure_md_string(((note.data or {}).get('content') or {}).get('md') or '')
...
async def replace_note_content(
    ...
    try:
        ...
        current_content = ensure_md_string(((note.data or {}).get('content') or {}).get('md') or '')
            ...
            for item in __model_knowledge__:
                ...
                if item_type == 'collection':
                    ...
                    if note and (
                        ...
                        content = ensure_md_string(((note.data or {}).get('content') or {}).get('md', ''))
                        note_results.append(
                            {
                                'content': content,
                                'source': note.title,
